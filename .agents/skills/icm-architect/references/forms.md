...
The selection table lives in `SKILL.md` (step 2 of Build / Restructure mode): ask **what is the repeating unit of work?** and pick the row. This file assumes a form is already chosen.
